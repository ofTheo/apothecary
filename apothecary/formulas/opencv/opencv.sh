...
#    D:/a/_temp/msys64/usr/bin/python.exe -mpip install numpy
    ...
    if [ $ARCH == 32 ] ; then
      mkdir -p build_vs_32
      cd build_vs_32
      "C/Program Files (x86)/Microsoft Visual Studio/2017/Community/VC/Auxiliary/Build/vcvarsall.bat" -arch=x86
      ...
      mkdir -p build_vs_64
      cd build_vs_64
      "C/Program Files (x86)/Microsoft Visual Studio/2017/Community/VC/Auxiliary/Build/vcvarsall.bat" -arch=x64
